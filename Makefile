PACKAGE_NAME := github.com/muhammadandikakurniawan/golang-todolistapp

deploy:
	docker-compose up --build -d

container-run:
	docker push andika6690/golangtodolist

image-tag:
	docker tag golang-todolistapp_api andika6690/golangtodolist
...
mock:
	...
	@echo "\n"
	mockery --all --output src/pkg/mocks --case underscore